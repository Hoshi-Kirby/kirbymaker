...
def step4():
        ...
        if _value.wazatype[_value.ka3]>0 :
            ...
            if _value.wazatype[_value.ka3]==1 :
                _func.help(760,250,4,"攻撃が地面に当たったときの挙動を選択します")
            else:
                _func.help(760,250,4,"攻撃中に地面に当たったときの挙動を選択します")
        if _value.wazatype[_value.ka3]==0 :
            _func.help(760,200,3,"技の攻撃範囲と時間を設定します")
        _func.help(760,300,5,"技の攻撃中にカービィが重力やプレーヤーの操作の影響を受けるかどうかを選択します")
        if _value.wazatype[_value.ka3]<2 :
            _func.help(760,450,6,"攻撃中にカービィが操作不能になり、移動するときの軌道と時間を設定します")
        else:
            _func.help(760,450,6,"攻撃後にカービィが操作不能になり、移動するときの軌道と時間を設定します")
        time.sleep(0.01)